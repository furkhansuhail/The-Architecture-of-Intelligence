  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", justifyContent: "center", marginBottom: 16 }}>
        <svg width={750} height={260} viewBox="0 0 750 260" style={{ background: "#08080d", borderRadius: 10, border: "1px solid " + C.border }}>
          {/* Cycle visualization */}
          {steps.map(function(s, i) {
            var x = 80 + i * 150;
            var on = step === i;
...
function TabDataPipeline() {
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", justifyContent: "center", marginBottom: 16 }}>
        <svg width={780} height={80} viewBox="0 0 780 80" style={{ background: "#08080d", borderRadius: 10, border: "1px solid " + C.border }}>
          {pSteps.map(function(s, i) {
            var x = 18 + i * 108;
            var on = step === i;
            var done = i < step;
...
function TabForgetting() {
  ...
  return (
    <div>
      ...
      {/* Chart */}
      <div style={{ display: "flex", justifyContent: "center", marginBottom: 16 }}>
        <svg width={700} height={280} viewBox="0 0 700 280" style={{ background: "#08080d", borderRadius: 10, border: "1px solid " + C.border }}>
          {/* Grid lines */}
